<div class="relative" x-data="{ open: false }">
	...
	<div
		...
		style="display: none;"
	>
		<div {{ $attributes->merge(['class' => 'w-full border-none shadow-lg relative flex flex-col pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current']) }}>
