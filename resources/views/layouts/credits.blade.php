<div class="max-w-7xl mx-auto px-2 sm:px-8 lg:px-10 pb-12 mt-8 flex flex-col justify-between gap-4">
	<div>
		...
		<div class="flex items-center mt-4">
			...
			<a href="https://github.com/devmount/stunden-check" class="ml-1 text-xs underline" target="_blank">
				{{ config('app.name', 'StundenCheck') }} auf GitHub
			</a>
			...
			<a href="https://paypal.me/devmount" class="ml-1 text-xs underline" target="_blank">
